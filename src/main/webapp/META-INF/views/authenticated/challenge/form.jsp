...
<acme:form readonly="true">
	...
	<acme:form-double code="authenticated.challenge.form.label.gold" path="goldReward"/>
	<acme:form-double code="authenticated.challenge.form.label.silver" path="silverReward"/>
	<acme:form-double code="authenticated.challenge.form.label.bronze" path="bronzeReward"/>
